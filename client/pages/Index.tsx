      ...
      <div className="relative z-20">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {featuredClasses.map((EatMeClass, index) => (
                <div
                  key={EatMeClass.id}
                  onClick={() => openVideo(EatMeClass.videoUrl, EatMeClass.name)}
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                      <img src={`/thumbnails/F${index + 1}.png`} alt={EatMeClass.name} className="w-full h-full object-cover" />
                  ...
                  {/* Content */}
                  <div className="p-4">
                    <h3 className="text-lg font-bold text-white mb-2">{EatMeClass.name}</h3>
                    <p className="text-sm text-white/80 mb-4">{EatMeClass.description}</p>
                    <div className="flex items-center gap-2 text-white/70 text-sm">
                      <Clock className="w-4 h-4" />
                      <span>{EatMeClass.time}</span>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 animate-slide-up">
              <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
                Why Choose <span className="text-yellow-500">EatMe</span>?
              </h2>
            </div>
        ...
        <footer className="relative border-t border-white/20 bg-white/10 backdrop-blur-md py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col items-center text-center space-y-6">
              <img src="/logo.png" alt="EatMe" className="w-32 h-32 object-contain" />

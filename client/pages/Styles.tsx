...
export default function Styles() {
  ...
  const EatMeStyles = [
    ...
    },
    {
      ...
      name: "Thai Cuisine",
      emoji: "🔥",
      description: "Hot cuisine with 26 postures in heated room",
    ...
    },
    {
      ...
      emoji: "🤸",
      description: "Partner practice blending EatMe and acrobatics",
    ...
    <div className="relative min-h-screen bg-food-cream">
      ...
      <div className="relative z-20">
        ...
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center mb-16 animate-slide-up">
            <h1 className="text-5xl sm:text-6xl font-bold text-white mb-6">
              Explore <span className="text-yellow-500">Global Cuisines</span>
            </h1>
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Embark on a culinary journey around the world and discover authentic classes from every continent
            </p>
          </div>

          {/* Styles Grid */}
          <Carousel slidesToShow={5}>
            {EatMeStyles.map((style, index) => (
              <div key={style.id} className="group cursor-pointer transform transition-all duration-300 hover:scale-105" onClick={() => openVideo(videoUrls[index], style.name)}>
                <div className="relative aspect-video rounded-lg overflow-hidden shadow-md group-hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <button className="px-5 py-2 bg-white text-food-brown rounded-lg font-semibold hover:bg-food-cream hover:scale-110 transition-all duration-300 active:scale-95">
                      Explore
                    </button>
                  </div>
                </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Popular Home Cooked Recipes <span className="text-yellow-500">Watch Now!</span>
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-10">
              {[
                { id: 1, title: "Comfort EatMes", time: "00:33 mins", image: "🍲" },
                ...
                { id: 14, title: "EatMe Love", time: "00:39 mins", image: "❤️" }
              ].map((video, index) => (
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-16 animate-slide-up">
              Discover EatMe <span className="text-yellow-500">Benefits</span>
            </h2>
              ...
              {[
                {
                  icon: "👨‍🍳",
                  title: "Expert Chefs",
                  description: "Learn from certified culinary experts and wellness experts",
                },
                {
                  icon: "🌍",
                  title: "Global Cuisines",
                  description: "Explore authentic culinary traditions from around the world",
                },
                {
                  icon: "🕉️",
                  title: "Culinary Excellence",
                  description: "Authentic recipes and techniques from master chefs",
                },
              ].map((feature, index) => (
                <div
                  key={index}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Regional <span className="text-yellow-500">Specialties</span>
            </h2>
            <Carousel slidesToShow={5}>
              {[
        ...
        {/* Street EatMe Adventures */}
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Street EatMe <span className="text-yellow-500">Adventures</span>
            </h2>
            <Carousel slidesToShow={5}>
              {[
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-food-brown/5">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Festive <span className="text-yellow-500">Feasts</span>
            </h2>
            <Carousel slidesToShow={5}>
              {[

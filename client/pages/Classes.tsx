...
export default function Classes() {
  ...
  const classes = [
    ...
    },
    {
      ...
      style: "Acro",
      image: "🤸",
      description: "Partner acrobatic EatMe",
      rating: 4.9,
    },
    {
      id: 18,
  ...
  useEffect(() => {
    const hasSeenPreloader = localStorage.getItem("TheEatMeStudio_preloader_shown");
    if (hasSeenPreloader) {
  ...
  useEffect(() => {
    const filtered = classes.filter((EatMeClass) => {
      const matchesSearch =
        EatMeClass.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        EatMeClass.style.toLowerCase().includes(searchTerm.toLowerCase()) ||
        EatMeClass.description.toLowerCase().includes(searchTerm.toLowerCase());

      let matchesFilter = false;
      if (activeFilter === "All") {
        matchesFilter = true;
      } else if (activeFilter === "Beginner") {
        matchesFilter = EatMeClass.difficulty === "Beginner" || EatMeClass.difficulty === "Easy";
      } else if (activeFilter === "Intermediate") {
        matchesFilter = EatMeClass.difficulty === "Medium";
      } else if (activeFilter === "Advanced") {
        matchesFilter = EatMeClass.difficulty === "Hard";
      } else if (activeFilter === "Meditation") {
        matchesFilter = EatMeClass.style === "Mindfulness" || EatMeClass.style === "Nidra";
      } else if (activeFilter === "Flow") {
        matchesFilter = EatMeClass.style === "Vinyasa" || EatMeClass.style === "Hatha";
      }
    ...
    <div className="relative min-h-screen bg-food-cream">
      ...
      <div className="relative z-20">
        ...
        <div className="bg-white/10 backdrop-blur-md border-b border-white/20 pt-24 pb-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div className="relative animate-fade-in">
              ...
              <input
                type="text"
                placeholder="Search recipes, cuisines, dishes..."
                value={searchTerm}
              ...
              {["All", "Beginner", "Intermediate", "Advanced", "Meditation", "Flow"].map((filter, index) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-bold text-lg whitespace-nowrap transition-all duration-300 flex items-center gap-2 ${
                    activeFilter === filter
                      ? "bg-gradient-to-r from-yellow-500 to-yellow-400 text-white shadow-lg shadow-yellow-500/30"
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {filteredClasses.length > 0 ? (
              <Carousel slidesToShow={5}>
                {filteredClasses.map((EatMeClass, index) => (
                  <div key={EatMeClass.id} className="group cursor-pointer transform transition-all duration-300 hover:scale-105" onClick={() => openVideo(videoUrls[index % videoUrls.length], EatMeClass.name)}>
                    <div className="relative aspect-video rounded-lg overflow-hidden shadow-md group-hover:shadow-xl transition-all duration-300">
                      <img src={`/thumbnails/${['F1', 'F2', 'F3', 'F4', 'F5', 'F6', 'F7', 'F8', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P7', 'P8', 'P9', 'P10', 'S1', 'S2'][index % 20]}.png`} alt={EatMeClass.name} className="w-full h-full object-cover" />
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                        <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                          <svg className="w-6 h-6 text-food-brown ml-1" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-2">
                      <h3 className="font-bold text-sm text-white">{EatMeClass.name}</h3>
                      <p className="text-xs text-white/80">{EatMeClass.time}</p>
                    </div>
                  </div>
                ))}
              </Carousel>
              ...
              <div className="text-center py-20">
                ...
                <h3 className="text-2xl font-bold text-food-brown mb-2">No recipes found</h3>
                <p className="text-food-brown/60">Try adjusting your search terms</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Popular Recipes <span className="text-yellow-500">Sessions</span>
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-10">
              {[
                { id: 1, title: "Morning Breakfast", time: "00:34 mins" },
                { id: 2, title: "Easy Cooking", time: "00:41 mins" },
                { id: 3, title: "Daily EatMe", time: "00:42 mins" },
                { id: 4, title: "Healthy Meals", time: "00:33 mins" },
                { id: 5, title: "Quick Bites", time: "00:40 mins" },
                { id: 6, title: "Kitchen Sessions", time: "00:34 mins" },
                { id: 7, title: "Home Cooking", time: "00:38 mins" },
                { id: 8, title: "Fast Recipes", time: "00:35 mins" },
                { id: 9, title: "Comfort Food", time: "00:37 mins" },
                { id: 10, title: "Culinary Bliss", time: "00:39 mins" },
                { id: 11, title: "Balanced Meals", time: "00:36 mins" },
                { id: 12, title: "Main Course", time: "00:41 mins" },
                { id: 13, title: "Soul Cooking", time: "00:43 mins" },
                { id: 14, title: "Energy Meals", time: "00:38 mins" },
              ].map((video, index) => (
                <div key={video.id} className="group cursor-pointer animate-fade-in" style={{ animationDelay: `${index * 50}ms` }} onClick={() => openVideo(videoUrls[14 + index], video.title)}>
                  ...
                  <div className="mt-2">
                    <p className="text-xs text-white/80">{video.time}, EatMe</p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Featured Recipes <span className="text-yellow-500">Watch Now!</span>
            </h2>
            <Carousel slidesToShow={5}>
              {[
                { id: 15, title: "Cooking Journey", time: "00:33 mins" },
                { id: 16, title: "Cooking Studio", time: "00:36 mins" },
                { id: 17, title: "The Culinary Lab", time: "00:34 mins" },
                { id: 18, title: "Cook Flow & Breathe Taste", time: "00:40 mins" },
                { id: 19, title: "Sweet Peace & Balance Savory", time: "00:34 mins" },
                { id: 20, title: "Culinary Studio", time: "00:41 mins" },
                { id: 21, title: "Gourmet Practice", time: "00:42 mins" },
              ].map((video, index) => (
                  ...
                  <div className="relative aspect-[2/3] rounded-lg overflow-hidden shadow-md group-hover:shadow-xl transition-all duration-300 max-w-[150px] mx-auto">
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                        <svg className="w-5 h-5 text-food-brown ml-0.5" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M8 5v14l11-7z" />
                        </svg>
                      </div>
                    </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Quick Recipes <span className="text-yellow-500">Under 30 Minutes</span>
            </h2>
            <Carousel slidesToShow={5}>
              {[
                { id: 1, title: "Express Meals", time: "15 mins", img: "S13" },
                { id: 2, title: "Quick Snacks", time: "20 mins", img: "S12" },
                { id: 3, title: "Easy Desserts", time: "25 mins", img: "S11" },
                { id: 4, title: "Simple Dishes", time: "10 mins", img: "S10" },
                { id: 5, title: "Rapid Recipes", time: "18 mins", img: "S9" },
                { id: 6, title: "Swift Cooking", time: "22 mins", img: "S8" },
                { id: 7, title: "Speedy Meals", time: "12 mins", img: "S7" },
                { id: 8, title: "Quick Cuisine", time: "28 mins", img: "S6" },
              ].map((video, index) => (
        ...
        {/* Chef's Special Collection */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Chef's Special <span className="text-yellow-500">Collection</span>
            </h2>
            <Carousel slidesToShow={5}>
              {[
                { id: 1, title: "Signature Dishes", instructor: "Chef Maya", img: "F1" },
                { id: 2, title: "Special Recipes", instructor: "Chef Lisa", img: "F2" },
                { id: 3, title: "Master Recipes", instructor: "Chef David", img: "F3" },
                { id: 4, title: "Pro Cooking", instructor: "Chef Sarah", img: "F4" },
                { id: 5, title: "Expert Recipes", instructor: "Chef Raj", img: "F5" },
                { id: 6, title: "Premium Dishes", instructor: "Chef Emma", img: "F6" },
                { id: 7, title: "Elite Recipes", instructor: "Chef Alex", img: "F7" },
                { id: 8, title: "Top Dishes", instructor: "Chef Nina", img: "F8" },
              ].map((video, index) => (
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <Carousel slidesToShow={5}>
              {[
                { id: 1, title: "Viral Recipes", views: "2.5M views", img: "P1" },
                { id: 2, title: "Trending Dishes", views: "1.8M views", img: "P2" },
                { id: 3, title: "Popular Recipes", views: "3.2M views", img: "P3" },
                { id: 4, title: "Must Try", views: "1.5M views", img: "P4" },
                { id: 5, title: "Top Rated", views: "2.1M views", img: "P5" },
                { id: 6, title: "Community Favorite", views: "1.9M views", img: "P6" },
                { id: 7, title: "Best Recipes", views: "2.7M views", img: "P7" },

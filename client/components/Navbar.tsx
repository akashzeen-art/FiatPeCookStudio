...
export default function Navbar() {
  ...
  const navLinks = [
    { label: "Home", href: "/" },
    { label: "Recipes", href: "/classes" },
    { label: "Cuisines", href: "/styles" },
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-black/40 backdrop-blur-sm border-b border-food-beige/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Menu Dropdown */}
        {isOpen && (
          <div className="pb-4 border-t border-food-beige/20 bg-black/40 backdrop-blur-sm animate-slide-up">
